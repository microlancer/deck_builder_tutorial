...
var parent: Control
var tween: Tween
var playable := true : set = _set_playable # do you have the mana to play it?
var disabled := false # are you dragging a different card?
...
func _set_playable(value: bool) -> void:
	playable = value
	if not playable:
		cost.add_theme_color_override("font_color", Color.MAROON)
...
func _on_card_drag_or_aiming_started(used_card: CardUI) -> void:
	if used_card == self:
		# don't disable the card we're actually dragging
		return
